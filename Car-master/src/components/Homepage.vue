                      ...
                      <div
                        ...
                        <div class="rc-step-content">
                          <h2
                            class="rc-step-title"
                            ref="pbdt"
                            v-if="index === 0">{{langs.DOWNLOAD_LABEL}}</h2>
                          <h2
                            class="rc-step-title"
                            ref="pbat"
                            v-if="index === 1">{{langs.AUTH_LABEL}}</h2>
                          <h2
                            class="rc-step-title"
                            ref="pbat"
                            v-if="index === 2">{{langs.EDUCATION_LABEL}}</h2>
                          <h2
                            class="rc-step-title"
                            ref="pbat"
                            v-if="index === 3">{{langs.SUMMER_LABEL}}</h2>
                        ...
                        <!--
                          ...
                          <button
                            class=""
                            ref="pbat"
                            v-if="index === 2">{{langs.EDUCATION_LABEL}}</button>
                          <button
                            class=""
                            ref="pbat"
                            v-if="index === 3">{{langs.SUMMER_LABEL}}</button>-->
          ...
          <div class="rc-page rc-page04">
            ...
            <div class="rc-content-wrapper">
              <div class="rc-bg rc-drive-stage">
                <!--工号：<input type="text" v-model="username" stype="width:240px">
              意见：<textarea v-model="advice" style="width:240px"></textarea>
              <button>提交</button>-->
                <el-form id="form" ref="form" :model="AdviceForm" class="login-container" lable-position="left"
                         lable-width="0px" v-loading="loading">
                  <h3 class="login_title"><h2>{{langs.PAGE_FOUR_SLOGAN}}</h2></h3>
                  <el-form-item prop="username">
                    <el-input type="text" v-model="AdviceForm.username" auto-complete="false" placeholder="请输入工号" ></el-input>
                  </el-form-item>
                  <el-form-item prop="password">
                    <el-input type="text" v-model="AdviceForm.password" auto-complete="false" placeholder="请输入部门"></el-input>
                  </el-form-item>
                  <el-form-item prop="code">
                    <el-input type="text" v-model="AdviceForm.code" auto-complete="false" placeholder="请输入意见"></el-input>
                  </el-form-item>
                  <el-form-item>
                  <img :src="captchaUrl" @click='updateCaptcha'>
                  </el-form-item>
                  <el-form-item style="width:100%; text-align:center;">
                    <el-button type="primary" style="width:20%" @click="submitClick">提交</el-button>
                  </el-form-item>
                </el-form>
                <el-form :rules="rules" class="nessesary-container" lable-position="left"
                         lable-width="0px" v-loading="loading">
                  <h3 class="login_title"><h2>{{langs.PAGE_FOUR_NECCESSARY}}</h2></h3>
                  <div v-for="(context,index) in langs.PAGE_FOUR_CONTEXTGROUP" :key="index">
                    <p>{{context}}</p>
                  </div>
                </el-form>
                <!--<div
...
export default {
  ...
  data() {
    return {
      ...
      stepIndex: 0,
      rules:{
        username:[{required:true, rigger:'blur'}],
  ...
  methods: {
    ...
    submitClick(){
      this.$refs.form.validate((valid)=>{
        if(valid){
          //alert('as');
          postRequest('/login/doLogin', this.AdviceForm).then(resp=>{
            if(resp){
              //alert(reap);
